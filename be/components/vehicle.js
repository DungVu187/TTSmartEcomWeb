...
const { listVehicles, createVehicle, updateVehicle, updateVehicleStatus, deleteVehicle } = require('../controllers/vehicleController');
...
router.delete('/:id', [authenticateAdmin, checkPermission('tireorder.delete')], deleteVehicle);
